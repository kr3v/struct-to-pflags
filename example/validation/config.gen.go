...
func withFlags(cmd *cobra.Command) *cobra.Command {
	...
	pflags.String(flagLogFile, defaultConfig.logFile, "path to file where logs will be written")
	pflags.Bool(flagDebug, defaultConfig.debug, "enable debug mode")
	pflags.Int(flagPort, defaultConfig.port, "port number to listen on")
	return cmd
}
